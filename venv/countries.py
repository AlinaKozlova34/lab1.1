...
def create_question(question = None, question_kid = None) :
    if question is None:
        ...
        print("Введите вопрос или ответ который вы бы сказали, если бы ответили на вопрос {} Да. \n Если вы хотите ввести ответ, то нажмите \"0\"".format(question.question))

    else :
        print("Введите вопрос или ответ который вы бы сказали, если бы ответили на вопрос {} Нет. \n Если вы хотите ввести ответ, то нажмите \"0\" ".format(question.question))
